 ...
 */
final class Version20250113154701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rapport_veterinaire ADD animal_id INT NOT NULL, DROP animal');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rapport_veterinaire ADD animal VARCHAR(150) DEFAULT NULL, DROP animal_id');
    }
}
